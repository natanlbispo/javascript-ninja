...
console.log(text.replace(/Manuel Marques de Sousa/, "Teste"));
...
console.log(text.replace(/brasileiro/, "NATURALIDADE"));
...
console.log(text.replace(/O Centauro de Luvas/g, (muda)=>{
...
regu  lar que irá fazer o match com as datas. Crie grupos de captura para o
...
let regex =/(\d\d) de (julho|junho) de (\d\d\d\d)/g;
console.log(regex);
...
*/
console.log( '\nReplace de datas:' );
console.log(text.replace(regex,  (regex, dia,mes ,ano) =>{ //mesmo não utilizando o regex tem que passa ele na função do segundo paramentro do replace
